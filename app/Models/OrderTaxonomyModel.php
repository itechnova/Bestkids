...
class OrderTaxonomyModel extends Model
{
    protected $table      = 'taxonomyorder';
    ...
    protected $allowedFields = ['idorder', 'idtaxonomy', 'typed', 'content'];
    ...
    public function ExistsBy($Typed, $idTaxonomy){
        return $this->where('typed', $Typed)->where('idtaxonomy', $idTaxonomy)->first();
